...
set CLASSPATH=%APP_HOME%\lib\api-1.0-SNAPSHOT.jar;%APP_HOME%\lib\core-1.0-SNAPSHOT.jar;%APP_HOME%\lib\utils-1.3.5.jar


@rem Execute api
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %API_OPTS%  -classpath "%CLASSPATH%" src/main/java/com/epam/App.java %*
